function [ni_m,sum_m] = nevis_moulins_density_joughin(x_m,y_m,gg,oo,aa,ps)
...
% L. Andrews Thesis Fig. 2.6 Swiss Camp region moulin densities data 2011
    ...
    p_m = [0, 0, 0.1, 0.15, 0.2415, 0.2415, 0.2019, 0.2469, 0.1193, 0.1042, 0.0614, 0.0165, 0.0165, 0.01, 0.005, 0.005]'./(1e6); % moulin density in moulin/m2 for Joughin 2013 region  	
    x_m = []; y_m = [];

...
year = 2010;
[COH2, covar] = nevis_coherence_V2010_bed(fn, tis, zz_nevis); 
[COH2, covar] = nevis_coherence_2010_bed(fn, tis, zz_nevis); 
[COH2, covar] = nevis_coherence_V2010_surface(fn, tis, zz_nevis); 
[COH2, covar] = nevis_coherence_2010_surface(fn, tis, zz_nevis); 
[COH2, covar] = nevis_coherence_V2010_thickness(fn, tis, zz_nevis); 
[COH2, covar] = nevis_coherence_2010_thickness(fn, tis, zz_nevis); 
[COH2, covar] = nevis_coherence_V2010_slope(fn, tis, zz_nevis); 
[COH2, covar] = nevis_coherence_2010_slope(fn, tis, zz_nevis); 
[COH2, covar] = nevis_coherence_V2010_tau(fn, tis, zz_nevis); 
[COH2, covar] = nevis_coherence_2010_tau(fn, tis, zz_nevis); 
